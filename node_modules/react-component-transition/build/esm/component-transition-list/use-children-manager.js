 ...
 */
export var useChildrenManager = function (children) {
    var childrenMapper = useRef({});
    var internalKeys = useRef([]);
    var exitKeys = useRef([]);
    var enterKeys = useRef([]);
    ...
    var _loop_1 = function (i) {
        ...
        internalKeysUpdated = __spreadArrays(internalKeysUpdated.slice(0, index), [
