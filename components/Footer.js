...
export default function Footer() {
  return (
    <footer className="bg-red-900 w-full border-yellow-300mx-auto">
          ...
          <section className='md:flex md:flex-row md:justify-Elderly md:items-center'>
            {/*======================================== Flexbox ================================================ */}
            {/*======================================== Item 1  ================================================ */}
            <div className='hidden md:block md:w-4/12 md:h-36'></div>


            {/*======================================== Item 2  ================================================ */}
            <div className="w-4/12 flex flex-col items-center mt-16">
                  <div className="flex mb-3 space-x-4 ">
                    ...
                    <div className="mx-autoaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaex flex-row items-center justify-center mb-2 space-x-2 text-xs text-gray-300 dark:text-gray-400 font-mono ">
      ...
      {/*======================================== Item 3  ================================================ */}
          ...
          <div className='flex flex-col w-4/12 justify-start items-end gap-x-5 md:mt-12 md:flex md:items-start                                             md:gap-x-0x md:justify'>
